  ...
  return (
    <div ref={ref} id="about" className="pt-2 pb-2">
      ...
      <div className="2md:flex">
        <div className="pl-5 pr-5 w-full 2md:flex-grow-1 border">
          <div className="relative min-w-[300px] max-w-[450px] max-h-[450px]">
        ...
        <div className="2md:flex-grow-1 border w-full">
          <div className="p-5 pb-0 mb-0 font-nunito ">
            <p className="mb-4">
              Hey, I&apos;m Kenan Garayev. I&apos;m an experienced software
              developer and an ex-civil engineer.
            </p>
            <p className="mb-4">
              In the realm of software, my skill set is extensive. I excel in
              frontend and backend development and devops engineering.
            </p>
            {/* <p className="mb-8">
              My path to software engineering was anything but linear. Starting
              off with a degree from UCL, I became a Chartered Engineer and
              project manager in civil engineering, accumulating over 7 years of
              experience. However, my passion shifted to software engineering,
              moving away from managing big construction projects. My early
              school days dabbling in Pascal, C, and Python, followed by
              intensive Bootcamp training, led me back to solving
              construction-related problems with new tech insights.{" "}
            </p> */}
          </div>
        </div>
      </div>
